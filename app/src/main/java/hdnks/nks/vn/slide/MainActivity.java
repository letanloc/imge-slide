...
//        });
    ...
    // các lựa chọn dành cho bạn bạn chọn một các tên và bỏ vào     mDemoSlider.setPresetTransformer("Accordion");
/*    Default("Default"),
        Accordion("Accordion"),
...
//        Toast.makeText(this,slider.getBundle().get("extra") + "",Toast.LENGTH_SHORT).show();
    // khi ấn gía trị con của tắm ảnh nó có thể chuyển qua một tắm ảnh khác
